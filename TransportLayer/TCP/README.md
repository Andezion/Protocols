...
Установка соединения осуществляется с помощью, так называемого трехстороннего рукопожатия TCP. Инициатором соединения может выступать любая сторона, то есть и сервер может попросить соединение и наоборот - клиент.
