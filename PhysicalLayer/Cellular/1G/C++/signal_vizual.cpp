...
void draw_mesh() {
    ...
    DrawTriangle((Vector2){ static_cast<float>(screenWidth) / 5 + static_cast<float>(screenWidth) / 100, static_cast<float>(screenHeight) / 6 + static_cast<float>(screenHeight) / 60 },
    ...
    DrawTriangle((Vector2){static_cast<float>(screenWidth) / 10 * 8 + static_cast<float>(screenWidth) / 100 * 9, static_cast<float>(screenHeight) / 6 * 4 + },
                (Vector2){static_cast<float>(screenWidth) / 10 * 8 + static_cast<float>(screenWidth) / 100 * 7 + static_cast<float>(screenWidth) / 1000 * 8, static_cast<float>(screenHeight) / 6 * 4 + }, 
                (Vector2){static_cast<float>(screenWidth) / 10 * 8 + static_cast<float>(screenWidth) / 100 * 7 + static_cast<float>(screenWidth) / 1000 * 8, static_cast<float>(screenHeight) / 6 * 4 + }, BLACK);
