...
То есть по факту VLAN - это просто дополнительный тег в Ethernet-кадре, который мы используем при фильтрации трафика.
...
Ещё есть хорошая статья на эту тему - [вот тут](https://habr.com/ru/articles/319080/)