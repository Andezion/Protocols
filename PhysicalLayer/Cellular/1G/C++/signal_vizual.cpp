...
void draw_mesh() {
    ...
    DrawTriangle((Vector2){static_cast<float>(screenWidth) / 10 * 8 + static_cast<float>(screenWidth) / 100 * 9, static_cast<float>(screenHeight) / 6 * 4 + static_cast<float>(screenHeight) / 60 * 9 },
                ...
                (Vector2){static_cast<float>(screenWidth) / 10 * 8 + static_cast<float>(screenWidth) / 100 * 7 + static_cast<float>(screenWidth) / 1000 * 8, static_cast<float>(screenHeight) / 6 * 4 + static_cast<float>(screenHeight) / 60 * 9 + static_cast<float>(screenHeight) / 600 * 5}, BLACK);
